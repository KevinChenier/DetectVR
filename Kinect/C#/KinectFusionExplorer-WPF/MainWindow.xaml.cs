...
namespace Microsoft.Samples.Kinect.KinectFusionExplorer
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged, IDisposable
    {
        ...
        /// <summary>
        /// The delay before reconstruction.
        /// </summary>
        private const int DelayReconstruction = 20;
        ...
        /// <summary>
        /// The send data thread to send data to unity.
        /// </summary>
        ...
        /// </summary>
        private float minDepthClip = /*FusionDepthProcessor.DefaultMinimumDepth;*/ 0.67f;
        ...
        /// <summary>
        /// Parameter to delay before reconstruction.
        /// </summary>
        private int delayReconstruction = DelayReconstruction + 1;
        ...
        /// <summary>
        /// Start the thread for sending data to unity
        /// </summary>
        private void StartSendDataThread()
        {
            if (null == this.sendDataThread)
            {
                this.sendDataThread = new Thread(this.SendDataThreadProc);
        ...
        /// <summary>
        /// This thread only calls the event when mouse click for mesh generation.
        /// </summary>
        private void SendDataThreadProc()
        {
            while (true)
            {
                this.CreateMeshButtonClick(null, null);
                Thread.Sleep(90);
            }
        }
        ...
        private void Process()
        {
            if (this.recreateReconstruction)
            {
                ...
                {
                    this.recreateReconstruction = /*false*/ true;

                    this.delayReconstruction++;

                    if (this.delayReconstruction >= DelayReconstruction)
                    {
                        this.RecreateReconstruction();
                        delayReconstruction = 0;
                    }
                }
            }
        ...
        private void CreateMeshButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                _Communicator.Write(Helper.SaveObjFileStringForUnity(mesh, true));
                ...
                //else if (true == this.objFormat.IsChecked)
                //{
                //using (StreamWriter writer = new StreamWriter(Directory.GetCurrentDirectory() + "\\Legs.txt"))
                //{
                //    //Default to flip Y, Z coordinates on save
